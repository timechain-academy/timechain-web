    ...
    <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
        <a class="block rounded-xl border border-gray-800 p-8 shadow-xl transition hover:border-pink-500/10 hover:shadow-pink-500/10"
          ...
          <h2 class="mt-4 text-xl font-bold text-white">Bitcoin</h2>
        ...
        <a class="block rounded-xl border border-gray-800 p-8 shadow-xl transition hover:border-pink-500/10 hover:shadow-pink-500/10"
          ...
          <h2 class="mt-4 text-xl font-bold text-white">Lightning</h2>
        ...
        <a class="block rounded-xl border border-gray-800 p-8 shadow-xl transition hover:border-pink-500/10 hover:shadow-pink-500/10"
          ...
          <h2 class="mt-4 text-xl font-bold text-white">Courses</h2>
        ...
        <a class="block rounded-xl border border-gray-800 p-8 shadow-xl transition hover:border-pink-500/10 hover:shadow-pink-500/10"
          ...
          <h2 class="mt-4 text-xl font-bold text-white">Developer Tools</h2>
